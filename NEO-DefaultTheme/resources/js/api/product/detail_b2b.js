  ...
  $.ajax({
      ...
      success: function (response) {
          if (response.success == true) {
              _alert("Alerta criado com sucesso", "Mensagem", "sucess");
          } else {
              _alert("Não foi possível criar o alerta: "+response.message, "Mensagem", "warning");
          }
      },
      error : function(request,error)
      {
          _alert("Erro ao criar alerta: "+error, "Mensagem", "error");
      }
  });
}

//CRIAR, INSTACIAR DA CLASSE - HEITOR
